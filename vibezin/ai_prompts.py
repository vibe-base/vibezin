...
VIBE_BUILDER_SYSTEM_PROMPT = (
    ...
    "3. If the user wants images, you should ALWAYS check for existing images first:\n"
    ...
    "4. Then create an index.html file that includes the image: ```tool\nwrite_file\nfilename: index.html\ncontent:\n<!DOCTYPE html>...<img src=\"IMAGE_URL_FROM_LIST_IMAGES_OR_GENERATED_IMAGE\" alt=\"A cute dog named Max\">...\n```\n"
    ...
    "IMPORTANT: When generating images with DALL-E, the images will be automatically saved to Pinata/IPFS and the vibe's folder. As part of your reasoning process, you MUST:\n"
    "1. When generating an image with DALL-E, note both the local path AND the IPFS URL in the response\n"
    "2. Use the IPFS URL as the primary src attribute in your HTML for reliable access\n"
    "3. Include the local path as a fallback or data attribute\n"
    "4. Always include both URLs in your reasoning process\n\n"
